...
export default function DepositandWithdrawal() {
  const columnsn = [
    ...
    "Accepted Currencies",
    "Our Fees",
    "Processing Times (First Time Withdrawals May Take Longer)",
  ];

  const datan = [
    {
      method: "M-Pesa, EAZZYPAY & Airtel Money",
      currency: "KES",
      fees: "Deposits & Withdrawals: $0",
      processing: "Deposits & Withdrawals: Instant",
    },
    {
      method: "MTN & Airtel UG",
      currency: "UGX",
      fees: "Deposits & Withdrawals: $0",
      processing: "Deposits & Withdrawals: Instant",
    },
    {
      method: "Vodacom, Airtel TZ, HaloPesa & TigoPesa",
      currency: "TZS",
      fees: "Deposits & Withdrawals: $0",
      processing: "Deposits: Instant | Withdrawals: Within 24 Hrs",
    },
  ];
